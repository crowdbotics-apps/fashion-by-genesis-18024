"""fashion_by_genesis_18024 URL Configuration
...
admin.site.site_header = "Fashion By Genesis"
admin.site.site_title = "Fashion By Genesis Admin Portal"
admin.site.index_title = "Fashion By Genesis Admin"

# swagger
schema_view = get_schema_view(
    openapi.Info(
        title="Fashion By Genesis API",
        default_version="v1",
        description="API documentation for Fashion By Genesis App",
    ),
    public=True,
